...
(let ((colors '(;; Upstream theme color
      ...
      (faces '(;; default
               ...
               ;; Posframe
               (frog-menu-posframe-background-face ,company-bg)
               ;; (frog-menu-posframe-background-face ,bg3)
               ;; powerline
               ...
               (linum-number-current-line :background ,pink-cat-boo-buffy-pink :foreground ,fg4)
					...
					(org-code :background ,company-bg)
               ...
               ;; (highlight-thing :background ,company-bg)
               (highlight-thing :background ,pink-cat-boo-buffy-current)
