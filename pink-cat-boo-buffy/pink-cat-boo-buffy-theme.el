...
(let ((colors '(;; Upstream theme color
      ...
      (faces '(;; default
               ...
               (region :background "#472541" :foreground "#FAFAFA")
               (selectrum-current-candidate :background ,pink-cat-boo-buffy-current)
					;; (grugru-highlight-face :box (:color ,pink-cat-boo-buffy-pink :line-width 1 :style nil) :background ,pink-cat-boo-buffy-dark)
					(grugru-highlight-face :underline ,pink-cat-boo-buffy-pink :background ,pink-cat-boo-buffy-dark :foreground ,pink-cat-boo-buffy-highlight)
               ...
               (font-lock-warning-face :foreground ,pink-cat-boo-buffy-orange :background ,bg2)
					;; auto-complete
               (ac-completion-face :underline t :foreground ,pink-cat-boo-buffy-pink)
               ;; company
               ...
               ;; helm
               (helm-bookmark-w3m :foreground ,pink-cat-boo-buffy-purple)
               (helm-buffer-not-saved :foreground ,pink-cat-boo-buffy-purple :background ,pink-cat-boo-buffy-bg)
               (helm-buffercess :foreground ,pink-cat-boo-buffy-orange :background ,pink-cat-boo-buffy-bg)
               (helm-buffer-saved-out :foreground ,pink-cat-boo-buffy-fg :background ,pink-cat-boo-buffy-bg)
               (helm-buffer-size :foreground ,pink-cat-boo-buffy-fg :background ,pink-cat-boo-buffy-bg)
               (helm-candidate-number :foreground ,pink-cat-boo-buffy-bg :background ,pink-cat-boo-buffy-fg)
               (helm-ff-directory :foreground ,pink-cat-boo-buffy-green :background ,pink-cat-boo-buffy-bg :weight bold)
               (helm-ff-dotted-directory :foreground ,pink-cat-boo-buffy-green :background ,pink-cat-boo-buffy-bg :weight normal)
               (helm-ff-executable :foreground ,other-blue :background ,pink-cat-boo-buffy-bg :weight normal)
               (helm-ff-file :foreground ,pink-cat-boo-buffy-fg :background ,pink-cat-boo-buffy-bg :weight normal)
               (helm-ff-invalid-symlink :foreground ,pink-cat-boo-buffy-pink :background ,pink-cat-boo-buffy-bg :weight bold)
               (helm-ff-prefix :foreground ,pink-cat-boo-buffy-bg :background ,pink-cat-boo-buffy-pink :weight normal)
               (helm-ff-symlink :foreground ,pink-cat-boo-buffy-pink :background ,pink-cat-boo-buffy-bg :weight bold)
               (helm-grep-cmd-line :foreground ,pink-cat-boo-buffy-fg :background ,pink-cat-boo-buffy-bg)
               (helm-grep-file :foreground ,pink-cat-boo-buffy-fg :background ,pink-cat-boo-buffy-bg)
               (helm-grep-finish :foreground ,fg2 :background ,pink-cat-boo-buffy-bg)
               (helm-grep-lineno :foreground ,pink-cat-boo-buffy-fg :background ,pink-cat-boo-buffy-bg)
               (helm-grep-match :foreground "unspecified-fg" :background "unspecified-bg" :inherit helm-match)
               (helm-grep-running :foreground ,pink-cat-boo-buffy-green :background ,pink-cat-boo-buffy-bg)
               (helm-header :foreground ,fg2 :background ,pink-cat-boo-buffy-bg :underline nil :box nil)
               (helm-moccur-buffer :foreground ,pink-cat-boo-buffy-green :background ,pink-cat-boo-buffy-bg)
               (helm-selection :background ,bg2 :underline nil)
               (helm-selection-line :background ,bg2)
               (helm-separator :foreground ,pink-cat-boo-buffy-purple :background ,pink-cat-boo-buffy-bg)
               (helm-source-go-package-godoc-description :foreground ,pink-cat-boo-buffy-yellow)
               (helm-source-header :foreground ,pink-cat-boo-buffy-pink :background ,pink-cat-boo-buffy-bg :underline nil :weight bold)
               (helm-time-zone-current :foreground ,pink-cat-boo-buffy-orange :background ,pink-cat-boo-buffy-bg)
               (helm-time-zone-home :foreground ,pink-cat-boo-buffy-purple :background ,pink-cat-boo-buffy-bg)
               (helm-visible-mark :foreground ,pink-cat-boo-buffy-bg :background ,bg3)
               ;; highlight-indentation minor mode
               (highlight-indentation-face :background ,bg2)
               ;; icicle
               (icicle-whitespace-highlight :background ,pink-cat-boo-buffy-fg)
               (icicle-special-candidate :foreground ,fg2)
               (icicle-extra-candidate :foreground ,fg2)
               (icicle-search-main-regexp-others :foreground ,pink-cat-boo-buffy-fg)
               (icicle-search-current-input :foreground ,pink-cat-boo-buffy-pink)
               (icicle-search-context-level-8 :foreground ,pink-cat-boo-buffy-orange)
               (icicle-search-context-level-7 :foreground ,pink-cat-boo-buffy-orange)
               (icicle-search-context-level-6 :foreground ,pink-cat-boo-buffy-orange)
               (icicle-search-context-level-5 :foreground ,pink-cat-boo-buffy-orange)
               (icicle-search-context-level-4 :foreground ,pink-cat-boo-buffy-orange)
               (icicle-search-context-level-3 :foreground ,pink-cat-boo-buffy-orange)
               (icicle-search-context-level-2 :foreground ,pink-cat-boo-buffy-orange)
               (icicle-search-context-level-1 :foreground ,pink-cat-boo-buffy-orange)
               (icicle-search-main-regexp-current :foreground ,pink-cat-boo-buffy-fg)
               (icicle-saved-candidate :foreground ,pink-cat-boo-buffy-fg)
               (icicle-proxy-candidate :foreground ,pink-cat-boo-buffy-fg)
               (icicle-mustmatch-completion :foreground ,pink-cat-boo-buffy-purple)
               (icicle-multi-command-completion :foreground ,fg2 :background ,bg2)
               (icicle-msg-emphasis :foreground ,pink-cat-boo-buffy-green)
               (icicle-mode-line-help :foreground ,fg4)
               (icicle-match-highlight-minibuffer :foreground ,pink-cat-boo-buffy-orange)
               (icicle-match-highlight-Completions :foreground ,pink-cat-boo-buffy-green)
               (icicle-key-complete-menu-local :foreground ,pink-cat-boo-buffy-fg)
               (icicle-key-complete-menu :foreground ,pink-cat-boo-buffy-fg)
               (icicle-input-completion-fail-lax :foreground ,pink-cat-boo-buffy-pink)
               (icicle-input-completion-fail :foreground ,pink-cat-boo-buffy-pink)
               (icicle-historical-candidate-other :foreground ,pink-cat-boo-buffy-fg)
               (icicle-historical-candidate :foreground ,pink-cat-boo-buffy-fg)
               (icicle-current-candidate-highlight :foreground ,pink-cat-boo-buffy-orange :background ,bg3)
               (icicle-Completions-instruction-2 :foreground ,fg4)
               (icicle-Completions-instruction-1 :foreground ,fg4)
               (icicle-completion :foreground ,pink-cat-boo-buffy-fg)
               (icicle-complete-input :foreground ,pink-cat-boo-buffy-orange)
               (icicle-common-match-highlight-Completions :foreground ,pink-cat-boo-buffy-purple)
               (icicle-candidate-part :foreground ,pink-cat-boo-buffy-fg)
               (icicle-annotation :foreground ,fg4)
               ;; icomplete
               (icompletep-determined :foreground ,pink-cat-boo-buffy-orange)
               ;; ido
               (ido-first-match
                ,@(if pink-cat-boo-buffy-alternate-mode-line-and-minibuffer
                      (list :weight 'normal :foreground pink-cat-boo-buffy-green)
                    (list :weight 'bold :foreground pink-cat-boo-buffy-pink)))
               (ido-only-match :foreground ,pink-cat-boo-buffy-orange)
               (ido-subdir :foreground ,pink-cat-boo-buffy-yellow)
               (ido-virtual :foreground ,pink-cat-boo-buffy-cyan)
               (ido-incomplete-regexp :inherit font-lock-warning-face)
               (ido-indicator :foreground ,pink-cat-boo-buffy-fg :background ,pink-cat-boo-buffy-pink)
               ;; isearch
               (isearch :inherit match :weight bold)
               (isearch-fail :foreground ,pink-cat-boo-buffy-bg :background ,pink-cat-boo-buffy-orange)
               ;; jde-java
               (jde-java-font-lock-constant-face :foreground ,pink-cat-boo-buffy-cyan)
               (jde-java-font-lock-modifier-face :foreground ,pink-cat-boo-buffy-pink)
               (jde-java-font-lock-number-face :foreground ,pink-cat-boo-buffy-fg)
               (jde-java-font-lock-package-face :foreground ,pink-cat-boo-buffy-fg)
               (jde-java-font-lock-private-face :foreground ,pink-cat-boo-buffy-pink)
               (jde-java-font-lock-public-face :foreground ,pink-cat-boo-buffy-pink)
               ;; js2-mode
               (js2-external-variable :foreground ,pink-cat-boo-buffy-purple)
               (js2-function-param :foreground ,pink-cat-boo-buffy-cyan)
               (js2-jsdoc-html-tag-delimiter :foreground ,pink-cat-boo-buffy-yellow)
               (js2-jsdoc-html-tag-name :foreground ,other-blue)
               (js2-jsdoc-value :foreground ,pink-cat-boo-buffy-yellow)
               (js2-private-function-call :foreground ,pink-cat-boo-buffy-cyan)
               (js2-private-member :foreground ,fg3)
               ;; js3-mode
               (js3-error-face :underline ,pink-cat-boo-buffy-orange)
               (js3-external-variable-face :foreground ,pink-cat-boo-buffy-fg)
               (js3-function-param-face :foreground ,pink-cat-boo-buffy-pink)
               (js3-instance-member-face :foreground ,pink-cat-boo-buffy-cyan)
               (js3-jsdoc-tag-face :foreground ,pink-cat-boo-buffy-pink)
               (js3-warning-face :underline ,pink-cat-boo-buffy-pink)
               ;; lsp
               ...
               ;; neotree
               (neo-banner-face :foreground ,pink-cat-boo-buffy-orange :weight bold)
               ;;(neo-button-face :underline nil)
               (neo-dir-link-face :foreground ,pink-cat-boo-buffy-purple)
               (neo-expand-btn-face :foreground ,pink-cat-boo-buffy-fg)
               (neo-file-link-face :foreground ,pink-cat-boo-buffy-cyan)
               (neo-header-face :background ,pink-cat-boo-buffy-bg
                                :foreground ,pink-cat-boo-buffy-fg
                                :weight bold)
               (neo-root-dir-face :foreground ,pink-cat-boo-buffy-purple :weight bold)
               (neo-vc-added-face :foreground ,pink-cat-boo-buffy-orange)
               (neo-vc-conflict-face :foreground ,pink-cat-boo-buffy-red)
               (neo-vc-default-face :inherit neo-file-link-face)
               (neo-vc-edited-face :foreground ,pink-cat-boo-buffy-orange)
               (neo-vc-ignored-face :foreground ,pink-cat-boo-buffy-comment)
               (neo-vc-missing-face :foreground ,pink-cat-boo-buffy-red)
               (neo-vc-needs-merge-face :foreground ,pink-cat-boo-buffy-red
                                        :weight bold)
               ;;(neo-vc-needs-update-face :underline t)
               ;;(neo-vc-removed-face :strike-through t)
               (neo-vc-unlocked-changes-face :foreground ,pink-cat-boo-buffy-red)
               ;;(neo-vc-unregistered-face nil)
               (neo-vc-up-to-date-face :foreground ,pink-cat-boo-buffy-green)
               (neo-vc-user-face :foreground ,pink-cat-boo-buffy-purple)
               ;; org
               ...
               (org-done :foreground ,pink-cat-boo-buffy-green)
               ...
               (org-todo :foreground ,pink-cat-boo-buffy-orange :weight bold :background ,bg2)
