...
(let ((colors '(;; Upstream theme color
                ...
                (dracula-comment "#7A71AB" "#5f5faf" "blue")        ; official comment
                (dracula-cyan    "#80ffea" "#87d7ff" "brightcyan")  ; official cyan
                (dracula-green   "#50fa7b" "#5fff87" "green")       ; official green
                (dracula-orange  "ff95804" "#ffaf5f" "brightred")   ; official orange
                (dracula-pink    "#ff79c6" "#ff87d7" "magenta")     ; official pink
                (dracula-purple  "#ff80bf" "#af87ff" "brightmagenta") ; official purple
      ...
      (faces '(;; default
               ...
               (marginalia-documentation :foregound ,dracula-comment :background ,dracula-bg :slant italic)
               ...
               ;; rainbow-delimiters
               (rainbow-delimiters-depth-1-face :foreground ,dracula-comment)
               ...
               ;; mark / region
               (region :background ,dracula-pink :foreground ,dracula-pink)
               ;; linum
